  ...
  },
  {
    ...
    children: [
      // 测试管理
      {
        ...
        redirect: '/testPerson',
        component: RouteView,
        meta: { title: '测试管理', keepAlive: true, icon: bxAnaalyse, permission: [ 'test' ] },
        children: [
          {
            path: '/testEnter',
            name: 'testEnter',
          ...
          },
          {
            path: '/testPerson',
            name: 'testPerson',
            component: () => import('@/views/testManage/testPerson'),
            meta: { title: '测试人员', keepAlive: false, permission: [ 'test' ] }
          },
          {
            path: '/testUndone',
            name: 'testUndone',
